...
func (c *IsolatedProcessorContext[Kout, Vout]) GetStore(name string) Store {
...
// Verify that IsolatedProcessorContext implements ProcessorContext
var _ ProcessorContext[any, any] = (*IsolatedProcessorContext[any, any])(nil)
var _ ProcessorContextInternal = (*IsolatedProcessorContext[any, any])(nil)
