...
//
// LEGACY: This interface receives only bare key-value pairs without metadata.
// For access to headers, timestamps, and offsets, use RecordProcessor instead.
...
// Deprecated: This Record type was never used. Use the Record type from record.go instead.
